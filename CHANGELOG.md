...
## [2.1.2](https://github.com/StackOneHQ/stack-nudge/compare/v2.1.1...v2.1.2) (2026-09-25)


### Bug Fixes

* **panel:** scroll the outcomes overview with the arrow keys ([#203](https://github.com/StackOneHQ/stack-nudge/issues/203)) ([49d05b8](https://github.com/StackOneHQ/stack-nudge/commit/49d05b82d871637ae64c960a799edd4c92acb68a))

## [2.1.1](https://github.com/StackOneHQ/stack-nudge/compare/v2.1.0...v2.1.1) (2026-09-24)


### Bug Fixes

* **panel:** find the right iTerm2 tab for tmux panes on any title setup ([#201](https://github.com/StackOneHQ/stack-nudge/issues/201)) ([dc74f32](https://github.com/StackOneHQ/stack-nudge/commit/dc74f32dca76cca7882517c5b3c064c35c42b634))
...
* **notify:** stop nudging about answered prompts, and rate-limit finished-turn DMs ([#173](https://github.com/StackOneHQ/stack-nudge/issues/173)) ([677ab14](https://github.com/StackOneHQ/stack-nudge/commit/677ab145dd1b727dbe822b39e6d39f4fbb2494bf))
...
* multi-client widget usage, prompt reminders, event history, and Slack delivery ([#164](https://github.com/StackOneHQ/stack-nudge/issues/164)) ([1b381eb](https://github.com/StackOneHQ/stack-nudge/commit/1b381ebdf1121f1c2b441f78878840c2eeb8c362))

## [1.30.0](https://github.com/StackOneHQ/stack-nudge/compare/v1.29.0...v1.30.0) (2026-08-21)


### Features

* **sessions:** link tabs and focus panes under tmux ([#160](https://github.com/StackOneHQ/stack-nudge/issues/160)) ([5e08989](https://github.com/StackOneHQ/stack-nudge/commit/5e089894fee3d6553c14b58eddac718ad394546a))

## [1.29.0](https://github.com/StackOneHQ/stack-nudge/compare/v1.28.2...v1.29.0) (2026-08-21)


### Features

* **widget:** free placement for the compact widget ([#159](https://github.com/StackOneHQ/stack-nudge/issues/159)) ([ee68ceb](https://github.com/StackOneHQ/stack-nudge/commit/ee68ceb433b1b39b00d1e16dc187bdd60813ae84))
...
* **panel:** hand focus to the source app on every open-editor path ([#148](https://github.com/StackOneHQ/stack-nudge/issues/148)) ([09ea677](https://github.com/StackOneHQ/stack-nudge/commit/09ea6775ef104abc1130956a13fd5bd94ac259ce))
...
* **panel:** keyboard-navigate the unwired-agents banner ([#137](https://github.com/StackOneHQ/stack-nudge/issues/137)) ([caf7f5b](https://github.com/StackOneHQ/stack-nudge/commit/caf7f5bad60f12198245d55e74ced4cc9fb22835))

## [1.25.2](https://github.com/StackOneHQ/stack-nudge/compare/v1.25.1...v1.25.2) (2026-07-20)


### Bug Fixes

* **panel:** stop the top bar shifting when a Stop row is selected ([#135](https://github.com/StackOneHQ/stack-nudge/issues/135)) ([df46f64](https://github.com/StackOneHQ/stack-nudge/commit/df46f645b99c757059d80e73dd45f1586a4990c1))

## [1.25.1](https://github.com/StackOneHQ/stack-nudge/compare/v1.25.0...v1.25.1) (2026-07-17)


### Bug Fixes

* **usage:** locate claude in ~/.local/bin; drop stale codex tiers ([#132](https://github.com/StackOneHQ/stack-nudge/issues/132)) ([6468b9f](https://github.com/StackOneHQ/stack-nudge/commit/6468b9f504162118cb041a5f17d11accd85d05c0))

## [1.25.0](https://github.com/StackOneHQ/stack-nudge/compare/v1.24.0...v1.25.0) (2026-07-15)


### Features

* **panel:** timed global mute + CLI-only Claude usage probe ([#130](https://github.com/StackOneHQ/stack-nudge/issues/130)) ([da9e5d6](https://github.com/StackOneHQ/stack-nudge/commit/da9e5d6070aaebf41ba107a80fa47a9ecd74fa44))
...
* **voice:** bump bundled stackvox floor to 0.7.0 ([#122](https://github.com/StackOneHQ/stack-nudge/issues/122)) ([929f9de](https://github.com/StackOneHQ/stack-nudge/commit/929f9de63d52b748a54b20fb9270cf55a0f8a04d))
...
* **quota:** read Claude quota via `claude /usage` instead of keychain ([#111](https://github.com/StackOneHQ/stack-nudge/issues/111)) ([d82ff77](https://github.com/StackOneHQ/stack-nudge/commit/d82ff77e7e7768bc0844b9646e6c88633df1c81f))

## [1.20.2](https://github.com/StackOneHQ/stack-nudge/compare/v1.20.1...v1.20.2) (2026-06-24)


### Bug Fixes

* **widget:** layout polish + accent color presets ([#108](https://github.com/StackOneHQ/stack-nudge/issues/108)) ([840d1d5](https://github.com/StackOneHQ/stack-nudge/commit/840d1d52632b3608509681f8b962c28f9e5c0530))

## [1.20.1](https://github.com/StackOneHQ/stack-nudge/compare/v1.20.0...v1.20.1) (2026-06-19)


### Bug Fixes

* **panel:** honor explicit Quit; align side text with gauge center ([#106](https://github.com/StackOneHQ/stack-nudge/issues/106)) ([d64b1cc](https://github.com/StackOneHQ/stack-nudge/commit/d64b1cccdfdadb8c0facd85e29d1bae54abc3aba))

## [1.20.0](https://github.com/StackOneHQ/stack-nudge/compare/v1.19.2...v1.20.0) (2026-06-17)


### Features

* **widget:** mini Usage widget + per-session mute + question-vs-approval split ([#104](https://github.com/StackOneHQ/stack-nudge/issues/104)) ([55e699f](https://github.com/StackOneHQ/stack-nudge/commit/55e699f9a72b66b625f41bddfd8e5c7bc9ebd5ff))

## [1.19.2](https://github.com/StackOneHQ/stack-nudge/compare/v1.19.1...v1.19.2) (2026-06-17)


### Bug Fixes

* **install:** pkill the correct app path on reinstall ([#101](https://github.com/StackOneHQ/stack-nudge/issues/101)) ([49df5e3](https://github.com/StackOneHQ/stack-nudge/commit/49df5e38056c20e17009c5a479939d7001ac7498))
* resolve permission deny across panel and banner ([#100](https://github.com/StackOneHQ/stack-nudge/issues/100)) ([7977ee7](https://github.com/StackOneHQ/stack-nudge/commit/7977ee78617031dd09d24f53153572941df0bffc))

## [1.19.1](https://github.com/StackOneHQ/stack-nudge/compare/v1.19.0...v1.19.1) (2026-06-17)


### Bug Fixes

* security & correctness hardening from deep-dive audit ([#98](https://github.com/StackOneHQ/stack-nudge/issues/98)) ([4b65ef2](https://github.com/StackOneHQ/stack-nudge/commit/4b65ef27fb64dfbbf5d7aa1c228bf3c247ea456b))
...
* **energy:** reduce idle widget rendering and session polling overhead ([#81](https://github.com/StackOneHQ/stack-nudge/issues/81)) ([443dc6a](https://github.com/StackOneHQ/stack-nudge/commit/443dc6a29d1591785e758c8d9d174d2b8f1b9e71))
